...
public class Main {
    ...
    public static void createMenu() {
        System.out.println("Добро пожаловать в 'Книгу сотрудников'");
        printChoice();
        printStartMenu();
    ...
    public static void goToSearchMenu() {
        while (true) {
            ...
            switch (scanner.nextInt()) {
                ...
                case 2 -> employeeBook.searchForMinSalary();
                case 3 -> employeeBook.searchForMaxSalary();
                case 4 -> searchForMinSalaryOfDepartment();
                case 5 -> searchForMaxSalaryOfDepartment();
    ...
    public static void createReadyEmployeeBook() {
        employeeBook.addEmployee("Серебряков Кирилл Иванович", 76500, 1);
        employeeBook.addEmployee("Гуськов Георгий Игоревич", 9000, 5);
        employeeBook.addEmployee("Цветков Андрей Николаевич", 76800.23, 2);
        employeeBook.addEmployee("Сидоров Леонид Андреевич", 32500, 3);
        employeeBook.addEmployee("Яшкин Сергей Вячеславович", 82000, 5);
    ...
    public static void searchForMinSalaryOfDepartment() {
        System.out.println("Выберите отдел (1-5): ");
        int numDepartment = scanner.nextInt();
        employeeBook.searchForMinSalaryOfDepartment(numDepartment);
    }

    public static void searchForMaxSalaryOfDepartment() {
        System.out.println("Выберите отдел (1-5): ");
        int numDepartment = scanner.nextInt();
        employeeBook.searchForMaxSalaryOfDepartment(numDepartment);
    }
